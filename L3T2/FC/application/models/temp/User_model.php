...
class User_model extends CI_Model 
{
	...
	public function register($data)				//COMPLETE REGISTRATION
	{
		...
		$query = $this->db->insert('userInfo',array(NULL,$data['user_name'],$data['email'],$data['password'],$data['birthday'],$data['country']));
	}
	...
	public function create_user_match_team($user_id, $match_id,$captain_id,$user_team,$team_name)
	{
		...
		$tournament_id=$this->tournament_model->get_active_tournament_id();
		$sql='INSERT into user_tournament VALUES(NULL,?,?,?)';
		...
		*/
		...
		$sql='INSERT into user_match_team VALUES(NULL,?,?,?,0)';
		...
		{
			$sql='INSERT into user_match_team_player VALUES(NULL,?,?)';
	...
	*/
	...
	{
		$sql='INSERT into user_phase_transfer VALUES(NULL,?,?,0)';
	...
	{
		$sql='INSERT into user_phase_transfer VALUES(NULL,?,?,NULL)';
		$query=$this->db->query($sql,array($user_id,$phase_id));
	}
